#train_from=/panfs/panmt/users/xmyang/OpenNMT-py/zh2en_model_6250/model_step_34000.pt
gpu_num=2
batchsize=4096
accumcount=4
model_path=zh2en_model_futurecost_test_${accumcount}_${batchsize}_bpe
