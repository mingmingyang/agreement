step=2000
result=result_cossim_$step
gpu=2
model_path=zh2en_model_futurecost_from_test_4_4096_bpe
mkdir $result

CUDA_VISIBLE_DEVICES=$gpu python costsentences.py -gpu 0 -model $model_path/model_step_$step.pt -src ../thumt_data/test_data/nist04.bpe.cn -tgt ./nist04.out -output ./$result/nist04.bpe.output
...
#CUDA_VISIBLE_DEVICES=$gpu python costsentences.py -gpu 0 -model $model_path/model_step_$step.pt -src ../thumt_data/test_data/nist04.bpe.cn -tgt ../thumt_data/test_data/nist04.bpe.en0 -output ./$result/nist04.bpe.output
